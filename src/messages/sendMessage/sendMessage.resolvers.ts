...
//   payload: string; // 'text' 필드를 'payload' 필드로 변경했습니다.
//   roomId?: number;
//   userId?: number;
// }
...
//   Mutation: {
//     sendMessage: async (_, { payload, roomId, userId }: SendMessageArgs, { prisma, loggedInUser, handleCheckLogin }: Context): Promise<SendMessageResult> => {
//       try {
...
//             data: {
//               payload, // 기존 'text' 필드를 'payload'로 변경했습니다.
